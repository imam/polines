        ...
        <div class="card">
          <div class="card-body">
            ...
            @endif
              ...
              <div class="form-group">
                <label>Nama</label>
                <input value="{{$classroom->name}}"type="text" class="form-control" placeholder="Nama" name="name">
              </div>
              <div class="form-group">
                <label>Lokasi</label>
                <input value="{{$classroom->location}}"type="text" class="form-control" placeholder="Lokasi" name="location">
              </div>

        ...
        <div class="card">
          <div class="card-body">
            ...
            @endif
              ...
              <div class="form-group">
                <label>Nama</label>
                <input value="{{$lecture->name}}"type="text" class="form-control" placeholder="Nama" name="name">
              </div>
              <div class="form-group">
                <label>SKS</label>
                <input value="{{$lecture->sks}}"type="text" class="form-control" placeholder="SKS" name="sks">
              </div>
